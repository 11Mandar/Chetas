...
fs.writeFileSync(path.join(rootDir, 'Stream-Windows-Logs.bat'), batContent, 'ascii');
console.log('Stream-Windows-Logs.bat successfully generated with Windows CRLF line endings.');
